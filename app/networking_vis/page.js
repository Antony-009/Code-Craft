...
const protocols = [
  { href: "/networking_vis/tcp", title: "TCP", description: "A step-by-step visualization of the TCP handshake.", gradientFrom: "#2196f3", gradientTo: "#1976d2", protocolType: "tcp" },
  { href: "/networking_vis/udp", title: "UDP", description: "A step-by-step visualization of the UDP protocol.", gradientFrom: "#22d3ee", gradientTo: "#06b6d4", protocolType: "udp" },
  { href: "/networking_vis/ftp", title: "FTP", description: "A step-by-step visualization of the FTP protocol.", gradientFrom: "#ffc107", gradientTo: "#ff0", protocolType: "ftp" },
  { href: "/networking_vis/smtp", title: "SMTP", description: "A step-by-step visualization of the SMTP protocol.", gradientFrom: "#ffc107", gradientTo: "#ffa000", protocolType: "smtp" },
  { href: "/networking_vis/pop3", title: "POP3", description: "A step-by-step visualization of the POP3 protocol.", gradientFrom: "#f0f", gradientTo: "#8b5cf6", protocolType: "pop3" },
  { href: "/networking_vis/http", title: "HTTP", description: "A step-by-step visualization of the HTTP protocol.", gradientFrom: "#ffc107", gradientTo: "#ff0", protocolType: "http" },
  { href: "/networking_vis/https", title: "HTTPS", description: "A step-by-step visualization of the HTTPS protocol.", gradientFrom: "#bdbdbd", gradientTo: "#D4D4D8", protocolType: "https" },
  { href: "/networking_vis/dns", title: "DNS", description: "A step-by-step visualization of the DNS protocol.", gradientFrom: "#3b82f6", gradientTo: "#2563eb", protocolType: "dns" },
  { href: "/networking_vis/icmp", title: "ICMP", description: "A step-by-step visualization of the ICMP protocol.", gradientFrom: "#6366F1", gradientTo: "#6366F1", protocolType: "icmp" },
  { href: "/networking_vis/imap", title: "IMAP", description: "A step-by-step visualization of the IMAP protocol.", gradientFrom: "#84CC16", gradientTo: "#84CC16", protocolType: "imap" },
  { href: "/networking_vis/sftp", title: "SFTP", description: "A step-by-step visualization of the SFTP protocol.", gradientFrom: "#A0522D", gradientTo: "#8B4513", protocolType: "sftp" },
  { href: "/networking_vis/ptp", title: "PTP", description: "A step-by-step visualization of the PTP protocol.", gradientFrom: "#00CED1", gradientTo: "#48D1CC", protocolType: "ptp" },
  { href: "/networking_vis/ssh", title: "SSH", description: "A step-by-step visualization of the SSH protocol.", gradientFrom: "#4b5563", gradientTo: "#374151", protocolType: "ssh" },
  { href: "/networking_vis/ipv4", title: "IPv4", description: "A step-by-step visualization of the IPv4 protocol.", gradientFrom: "#ef4444", gradientTo: "#dc2626", protocolType: "ipv4" },
  { href: "/networking_vis/ipv6", title: "IPv6", description: "A step-by-step visualization of the IPv6 protocol.", gradientFrom: "#10b981", gradientTo: "#059669", protocolType: "ipv6" },
  { href: "/networking_vis/telnet", title: "Telnet", description: "A step-by-step visualization of the Telnet protocol.", gradientFrom: "#f59e0b", gradientTo: "#d97706", protocolType: "telnet" },
